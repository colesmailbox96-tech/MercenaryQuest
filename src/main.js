...
const config = {
  ...
  scene: [BootScene, GameScene, HUDScene, ShopScene, EquipmentPanel, FishingPanel, MiningPanel, SkillsPanel, FarmingPanel, CookingPanel, MerchantPanel, CompanionPanel, SettingsPanel],
